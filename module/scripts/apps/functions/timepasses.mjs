export default class TimePasses {
    static async open() {
      const dialogContent = await renderTemplate("module/templates/dialogs/timepasses-dialog.hbs");
      ...
      new foundry.applications.api.DialogV2({
        ...
        buttons: [{
          ...
          callback: (event, button, dialog) => {
            return button.form.elements.minutes.valueAsNumber;
          }
        }],
        submit: async (result) => {
          ...
          const cardContent = await renderTemplate("module/templates/chats/timepasses-card.hbs", {
            minutes: result,
            expiredEffectsText
          });
    ...
    static async _checkForEncounter(threshold = 3) {
